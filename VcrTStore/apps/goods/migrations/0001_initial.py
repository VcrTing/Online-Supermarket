    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_front_image', models.ImageField(blank=True, null=True, upload_to='goods/front', verbose_name='代表性图片')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_type', models.IntegerField(choices=[(1, '一级类目'), (2, '二级类目'), (3, '三级类目')], help_text='类别描述')),
                ('is_tab', models.BooleanField(default=False, help_text='是否热门', verbose_name='是否热门')),
                ('add_time', models.DateField(default=datetime.datetime.now, help_text='添加时间', verbose_name='添加时间')),
                ('status', models.NullBooleanField(default=True, help_text='数据状态', verbose_name='数据状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(max_length=200, upload_to='brand/images/', verbose_name='图片')),
                ('add_time', models.DateField(default=datetime.datetime.now, help_text='添加时间', verbose_name='添加时间')),
                ('status', models.NullBooleanField(default=True, help_text='数据状态', verbose_name='数据状态')),
            ],
            options={
